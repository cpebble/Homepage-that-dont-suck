...
<script>
function expand(){
	$('.siteList').slideDown({duration:"fast"});
...
<div id="sites">
<div class=""onmouseenter="expand();" onmouseleave="retract();"><a href='#' id='%title' class='site' >%title</a><ul class="siteList"><li><a>Testlink1</a></li>
<li>Testlink2</li>
<li>Testlink3</li></ul></div>
</div>
<div id="boxes">
...
<script>$('.site').last().remove();$('.site').last().remove();$('.site').last().remove();$('.site').last().remove();$('.site').last().remove();</script>
</body>
</html>
